...
def base_result(model: NormalizedModel) -> dict[str, Any]:
    return {
        ...
        "newest_rank": model.newest_rank,
        "selection_rank": model.selection_rank,
        "selection_bucket": model.selection_bucket,
        "selection_reason": model.selection_reason,
        "created_at_utc": model.created_at_utc,
        "created_at_source": model.created_at_source,
        "model_age_days": model.model_age_days,
        ...
        "supports_coding": model.supports_coding,
        "supports_reasoning": model.supports_reasoning,
        "supports_function_calling": model.supports_function_calling,
        "supports_embedding": model.supports_embedding,
        "capability_tags": model.capability_tags,
        "usecase_tags": model.usecase_tags,
        "deployment_providers": model.deployment_providers,
        "test_status": "pending",
        "http_status": "",
        "latency_total_ms": "",
        "retry_count": 0,
